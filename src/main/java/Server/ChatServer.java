...
public class ChatServer {
  ...
  static Map<String, Integer> idToUserId = new HashMap<>();
  ...
  public static void main(String[] args) throws IOException {
    ...
    String HOST = "0.0.0.0"; // Connection request sent to any interface of this server machine will be
                             // redirected to this socket because of this 0 IP
    int PORT = 3000;
  ...
  private static void handleAuth(Map<String, Object> payload, ClientSession client) throws IOException {
    ...
    client.id = clientId;
    if (!idToUserId.containsKey(clientId)) {
      idToUserId.put(clientId, idToUserId.size() + 1);
    }
